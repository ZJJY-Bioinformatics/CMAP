                                              ...
                                              numericInput(ns("offset.abun"), "offset.abun:", 0.04, 0, 5) %>%
                                                  shinyInput_label_embed(
                                                      icon("circle-question") %>%
                                                          bs_embed_tooltip(title = "The width between the tree and abundance panel")
                                                  )
                                       ),
                                       column(width = 6,
                                              ...
                                              numericInput(ns("pwidth.abun"), "pwidth.abun:", 0.8, 0, 5) %>%
                                                  shinyInput_label_embed(
                                                      icon("circle-question") %>%
                                                          bs_embed_tooltip(title = "The panel width of abundance panel")
                                                  )
                                       )
                                   ),
                                   fluidRow(
                                       column(width = 6,
                                              ...
                                              numericInput(ns("offset.effsize"), "offset.effsize:", 0.3, 0, 5) %>%
                                                  shinyInput_label_embed(
                                                      icon("circle-question") %>%
                                                          bs_embed_tooltip(title = "The width between the tree and effect size panel")
                                                  )
                                       ),
                                       column(width = 6,
                                              style=list("padding-left: 5px;"),
                                              numericInput(ns("pwidth.effsize"), "pwidth.effsize:", 0.5, 0, 5) %>%
                                                  shinyInput_label_embed(
                                                      icon("circle-question") %>%
                                                          bs_embed_tooltip(title = "The panel width of effect size panel")
                                                  )
                                       )
                                   )        
                          ),
